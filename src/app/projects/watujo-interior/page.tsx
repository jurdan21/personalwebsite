  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen flex flex-row bg-white px-8 py-20 gap-[500px] max-w-[1440px] mx-auto">
        ...
        <div className="mb-0">
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: 'Power Grotesk, sans-serif', color: '#181818', fontWeight: 500 }}>Watujo Interior</h1>
          <p className="text-base md:text-lg " style={{ color: '#757575', fontFamily: 'Power Grotesk, sans-serif', fontWeight: 400 }}>
            [Deskripsi singkat project Watujo Interior di sini. Silakan edit sesuai kebutuhan.]
          </p>
          </div>
          {/* Detail(s) */}
          <div className="mb-0">
            ...
            <div className="w-full border-t border-b border-gray-200 divide-y divide-gray-200 text-sm md:text-lg" style={{ fontFamily: 'Power Grotesk, sans-serif' }}>
              ...
              <div className="flex py-2"><div className="w-32 text-gray-500">URL Link</div><div><a href="#" className="underline" target="_blank" rel="noopener">https://ui8.net/mordustwork/products/watuijo</a></div></div>
          ...
          <div className="mb-0">
            ...
            <p className="text-base md:text-lg" style={{ color: '#757575', fontFamily: 'Power Grotesk, sans-serif', fontWeight: 400 }}>
              [Problem statement untuk project Watujo Interior. Silakan edit sesuai kebutuhan.]
            </p>
          </div>
          {/* Research Objectives */}
          <div className="mb-0">
          ...
          <div className="mb-0">
            ...
            <ol className="list-decimal pl-6 text-base md:text-lg " style={{ color: '#757575', fontFamily: 'Power Grotesk, sans-serif', fontWeight: 400 }}>
              <li className="mb-4"><b style={{ color: '#181818' }}>Empathize</b><br />[Empathize step untuk Watujo Interior]</li>
              <li className="mb-4"><b style={{ color: '#181818' }}>Define</b><br />[Define step untuk Watujo Interior]</li>
              <li className="mb-4"><b style={{ color: '#181818' }}>Ideate</b><br />[Ideate step untuk Watujo Interior]</li>
              <li className="mb-4"><b style={{ color: '#181818' }}>Design</b><br />[Design step untuk Watujo Interior]</li>
              <li><b style={{ color: '#181818' }}>Deliver</b><br />[Deliver step untuk Watujo Interior]</li>
            </ol>
          </div>
        </section>
      </main>
      ...
      <section className="w-full bg-[#ffffff] flex flex-col items-center py-16 px-4 pb-[200px] gap-[20px]">
        ...
        <div className="w-full max-w-[1440px] aspect-[4/3] relative mb-5">
          <Image
            ...
            alt="Watujo Interior Project Hero"
            fill
